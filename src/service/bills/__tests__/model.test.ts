...
describe(`Bill model`, () => {
  ...
  describe(`Create Bill from BillEvent using createBill factory method`, () => {
    it(`Creates a new instance of the Bill class from a Legisinfo BillEvent object`, async () => {
      ...
      const testBill = {
        ...
        introduced_date: "2020/03/09",
        page_url:
          "https://www.parl.ca/LegisInfo/BillDetails.aspx?Language=E&billId=10686845",
        full_text_url: "https://parl.ca/DocumentViewer/en/10688120",
    ...
    it(`Creates a new instance of the Bill class from a Legisinfo BillEvent object`, async () => {
      ...
      const testBill = {
        ...
        introduced_date: "2020/02/27",
        page_url:
          "https://www.parl.ca/LegisInfo/BillDetails.aspx?Language=E&billId=10660264",
        full_text_url: "https://parl.ca/DocumentViewer/en/10670705",
        summary_url: undefined,
        passed: undefined,
      };
  ...
  describe("Private async data fetching methods", () => {
    const testBillPrototype = new Bill(testBillEvents[0]);
