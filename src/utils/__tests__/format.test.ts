...
describe(`FormatUtils methods`, () => {
  ...
  describe("formatCode", () => {
    ...
    it("Should return the bill code", () => {
      expect(FormatUtils.formatCode(testBill.description)).toBe("C-9");
    });
  });
  ...
  describe("formatTitle", () => {
    ...
    it("Should return the event title", () => {
      expect(FormatUtils.formatTitle(testBill.title)).toBe(
        "Introduction and First Reading in the House of Commons",
      );
    });

    it("Should return the bill title", () => {
      expect(FormatUtils.formatTitle(testBill.description)).toBe(
